...
```
sudo dnf install python3-snappy python3-protobuf python3-frozendict python3-defusedxml python3-filelock python3-psutil
```

```
sudo apt-get install python3-snappy python3-protobuf python3-frozendict python3-defusedxml python3-filelock python3-psutil
```
